...
- [ ] Kullanıcı talebi: siteyi komple denetle; auth, veritabanı, admin, görevler, workspace, PWA, mobil görünüm ve yayın akışındaki hataları düzelt.
- [ ] Kapsamlı QA sonrası testleri çalıştır, checkpoint oluştur ve yeni sürümü yayımla.
